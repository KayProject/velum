      ...
      <div className="relative z-10 mx-auto max-w-[1360px] px-6 sm:px-10">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <div className="mt-8 flex flex-wrap items-center justify-center gap-3.5">
            ...
            <Link
              href="/payer"
              className="btn-swing inline-flex items-center justify-center rounded-xl border border-[#ededed] bg-white/95 px-6 py-3.5 text-xs sm:text-sm font-medium text-[#181818] shadow-xs active:scale-95"
            >
              Try Demo
            </Link>
          </div>
